  ...
  void * untyped_ros_message)
{
  ...
  _Autodock_Goal__ros_msg_type * ros_message = static_cast<_Autodock_Goal__ros_msg_type *>(untyped_ros_message);
  // Field name: is_dock
  {
    uint8_t tmp;
    cdr >> tmp;
  ...
  void * untyped_ros_message)
{
  ...
  _Autodock_Result__ros_msg_type * ros_message = static_cast<_Autodock_Result__ros_msg_type *>(untyped_ros_message);
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _Autodock_Feedback__ros_msg_type * ros_message = static_cast<_Autodock_Feedback__ros_msg_type *>(untyped_ros_message);
  // Field name: step
  {
    cdr >> ros_message->step;
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, custom_interface, action, Autodock_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _Autodock_SendGoal_Request__ros_msg_type * ros_message = static_cast<_Autodock_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  void * untyped_ros_message)
{
  ...
  _Autodock_SendGoal_Response__ros_msg_type * ros_message = static_cast<_Autodock_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: accepted
  {
    uint8_t tmp;
    cdr >> tmp;
  ...
  void * untyped_ros_message)
{
  ...
  _Autodock_GetResult_Request__ros_msg_type * ros_message = static_cast<_Autodock_GetResult_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, custom_interface, action, Autodock_Result
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _Autodock_GetResult_Response__ros_msg_type * ros_message = static_cast<_Autodock_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: status
  {
    cdr >> ros_message->status;
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, custom_interface, action, Autodock_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _Autodock_FeedbackMessage__ros_msg_type * ros_message = static_cast<_Autodock_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
